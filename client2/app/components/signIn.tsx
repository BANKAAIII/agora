  ...
  `} >
    <div className="flex flex-col p-3
                    ...
                    <motion.div
                      ...
                      className=" flex w-full " onClick={()=>router.push("/")}>
                      <Image src={back} alt={"loading"} className=" hover:scale-120 hover:duration-130 dark:invert w-[25px] h-[25px] xl:w-[40px] xl:h-[40px]  xl:mt-[30px]" />
                    </motion.div>
                    {/* Title */}
                    <div className="flex mt-[40px] xl:mt-[44px] items-center justify-start dark:text-[#dcdcdc]  " ><a className=" font-openSans text-[24px] xl:text-[32px] font-medium">Log In</a></div>
                    {/* Input Box 1 */}
                    ...
                    <div className="flex items-center justify-center w-full mt-[50px]" >
                        <button className=" hover:scale-102 hover:duration:110 hover:shadow-lg hover:shadow-gray-950/30  w-[100px] h-[36px] rounded-full bg-TitleDot shadow-[17px_15px_29px_-14px_rgba(0,0,0,0.29)]">Sign In</button>
                    </div>
                    {/* Signin page Link */}
                    <div className="flex flex-row items-center justify-center w-full gap-2 mt-[30px] xl:mt-[50px]" >
                        <div className='dark:text-[#dcdcdc] ' >Already have an account</div>
                        <button className="cursor-pointer text-blue-600" onClick={()=>router.push("/signup")} > Sign-Up</button>
                    </div>
                    {/* buttons */}
