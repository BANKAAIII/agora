  ...
  return (
    <div className="relative  w-full min-h-screen  dark:bg-[#2C2C2C] overflow-hidden">
      ...
      <div className="relative  flex flex-col items-center justify-center">
        ...
        {/* md - Lg */}
        <div className="hidden md:block z-30" ><Signin /></div>
        {/* xs-sm */}
        <div className="md:hidden flex w-[300px] bg-TitleDot/20 rounded-4xl pt-[30px] pb-[50px]   mt-[20px] flex-col items-center justify-center " >
          ...
          <motion.div
                      ...
                      transition={{duration:0.5}} className=" flex w-full pl-[30px] ">
           <Image src={back} alt={"loading"} className=" hover:scale-120 hover:duration-130 dark:invert w-[30px] h-[30px]" />
          </motion.div>
                    {/* Title */}
          <div className="flex items-center justify-start dark:text-[#dcdcdc]  " ><a className=" font-openSans text-[24px] mt-[30px] font-medium">Log In</a></div>
                    {/* Input Box 1 */}
                    ...
                    <div className="flex items-center justify-center w-full mt-[50px]" >
                        <button className="w-[100px] h-[36px] rounded-full bg-TitleDot shadow-[17px_15px_29px_-14px_rgba(0,0,0,0.29)]">Sign In</button>
                    </div>
                    {/* Signin page Link */}
                    <div className="flex flex-row items-center justify-center w-full mt-[30px] lg:mt-[50px] gap-1.5" >
                        ...
                        <div className="text-blue-600 cursor-pointer" onClick={()=>router.push("/signup")}>Sign-Up</div>
                    </div>
                    {/* buttons */}
