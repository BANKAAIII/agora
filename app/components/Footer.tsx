...
const Footer = () => {
  ...
  return (
    <div className="w-full h-[250px] grid grid-row-2 md:grid-cols-3 " >
      ...
      <div className="flex items-center justify-center md:justify-end gap-6 mr-[32px] " >
        {/* Github */}
        <a href="https://github.com/BANKAAIII" target='blank'><Image src={githubDark} alt="loading" className=" sm:w-[40px] sm:h-[40px] md:w-[50px] md:h-[50px] "/></a>
        {/* Email Dark */}   
        <a href="https://gmail.com/ameyawarang203@gmail.com" target='blank'><Image src={emailDark} alt="loading" className=" sm:w-[40px] sm:h-[40px] md:w-[50px] md:h-[50px] "/></a>
        {/* x */}
        <a href="https://x.com/ammmeya" target='blank'><Image src={xDark} alt="loading" className=" sm:w-[40px] sm:h-[40px] md:w-[30px] md:h-[50px] "/></a>
        {/* discord */}
        <a href="https://x.com/ammmeya" target='blank'><Image src={discordDark} alt="loading" className=" sm:w-[40px] sm:h-[40px] md:w-[50px] md:h-[50px] "/></a>
      </div>
    </div>
  )
}
