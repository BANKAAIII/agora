      ...
      <div className="m-[25px] md:m-[81px] sm:w-[600px] md:w-[1600px] h-[700px] flex flex-row items-center justify-center gap-[50px] overflow-hidden" >
        ...
        <div className="flex flex-col items-center justify-start w-[858px] h-[637px]" >
          ...
          {/* title and Description */}
              ...
              {/* title */}
              <div className="flex sm:justify-center md:justify-start w-full" > <h1 className="font-poppins sm:text-[32px] md:text-[64px] font-semibold" >Get Started Today.</h1> </div>
              <div className="flex sm:justify-center md:justify-start w-full" ><h1 className="font-poppins sm:text-[18px] md:text-[24px] font-medium mt-4 " >Introducing the Agora Voting Protocol™ — our next-generation <br/>framework for secure, verifiable elections.</h1>
            ...
            <div className="flex flex-row gap-y-24 items-center justify-start w-full gap-x-8" >
              ...
              <div className=" flex flex-col items-center justify-center sm:w-[350px] md:w-[377px] h-[212px]" >
                 {/* title */}
                 <div className="flex w-full mt-[19px]" ><h1 className="font-poppins font-regular sm:text-[22px] md:text-[24px]" >Agora Ledger</h1></div>
              ...
              {/* card2 */}
              <div className=" flex flex-col items-center justify-center  sm:w-[350px] md:w-[377px] h-[212px]" >
                <div className="w-full mt-[19px]" ><h1 className="font-poppins font-regular sm:text-[22px] md:text-[24px]" >Agora Interface</h1></div>
            ...
            <div className="flex flex-row gap-y-24 items-center justify-start w-full gap-x-8" >
              {/* card3 */}
              <div className=" flex flex-col items-center justify-center sm:w-[350px] md:w-[377px] h-[212px]" >
                <div className="w-full flex mt-[19px]" ><h1 className="font-poppins font-regular sm:text-[22px] md:text-[24px]" >Agora Community</h1></div>
              ...
              {/* card4 */}
              <div className=" flex flex-col items-center justify-center sm:w-[350px] md:w-[377px] h-[212px]" >
                <div className="w-full flex mt-[19px]" ><h1 className="font-poppins font-regular sm:text-[22px] md:text-[24px]" >Gsoc</h1></div>
