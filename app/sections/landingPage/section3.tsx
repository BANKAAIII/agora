      ...
      <div className="m-[25px] lg:m-[81px] sm:w-[600px] md:w-[1600px] h-[700px] flex flex-row items-center justify-center gap-[50px] overflow-hidden" >
        ...
        <div className="flex flex-col items-center justify-start max-w-[858px] max-h-[637px]" >
          ...
          {/* title and Description */}
              ...
              {/* title */}
              <div className="flex justify-center md:justify-start w-full" > <h1 className="font-poppins text-[24px] sm:text-[32px] md:text-[49px] lgtext-[64px] font-semibold" >Get Started Today.</h1> </div>
              <div className="flex justify-center md:justify-start w-full" ><h1 className="font-poppins text-[14px] sm:text-[18px] md:text-[19px] lg:text-[24px] font-medium mt-4 " >Introducing the Agora Voting Protocol™ — our next-generation <br/>framework for secure, verifiable elections.</h1>
