...
const section2 = () => {
  return<div className="flex flex-col w-full  min-h-screen" >
      ...
      <div className="w-full flex" >
        <div className="pl-[25px] md:pl-[62px] mt-[15px]" >

          {/* Line 1 */}
          <div className="flex flex-row items-baseline gap-3 ">
            <h1 className="font-OpenSans text-[32px] sm:text-[40px] md:text-[64px] font-light italic text-black/90 " >Start Your</h1>
            <h1 className="font-poppins text-[32px] sm:text-[40px] md:text-[64px] italic font-semibold text-black/90  " >Journey.</h1>
          </div>

          {/* Line 2 */}
          <div className="mt-[5px] md:mt-[19px]" >
            <h1 className="font-OpenSans sm-[text-16px] sm:text-[20px] md:text-[24px] italic font-normal" >Choose a new way to vote.<br/> 
